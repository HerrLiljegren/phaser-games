Pacman.Main = function() {
        this.game = new Phaser.Game(896, 992, Phaser.AUTO, '', {
    ...
    this.tilemap, this.player, this.movementKeys, this.text, this.ghost;
}

Pacman.Main.prototype.preload = function() {
...
Pacman.Main.prototype.create = function() {
    this.game.score = 0;
    this.game.lives = 3;
    ...
    this.text = this.game.add.text(32, 32 * 10, getScoreBoardText(), {
        font: "14px Arial",
        fill: "#FFFFFF",
        align: "left"
    });
...
Pacman.Main.prototype.update = function() {
    ...
    this.player.update();
    this.ghost.update();
    this.text.setText(getScoreBoardText());
...
Pacman.Main.prototype.render = function() {
    //player.render();
}

Pacman.Main.prototype.getScoreBoardText = function() {
